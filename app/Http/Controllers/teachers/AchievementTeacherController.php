...
class AchievementTeacherController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return response()->view('teachers.achievements.index', ['achievements' => $data, 'students' => $students]);
    ...
    public function create()
    {
        ...
        // return response()->view('project.achievements.create');
    }
    ...
    public function edit($id)
    {
        ...
        $students = Student::all();
        return response()->view('teachers.achievements.edit', ['achievements' => $achievements, 'students' => $students]);
