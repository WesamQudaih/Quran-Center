...
class ActivitesController extends Controller
{
    ...
    {
        $data = Activity::all();
        return response()->view('admin.activities.index', ['activities' => $data]);
    }
    ...
    {
        $data = Circle::all();
        return response()->view('admin.activities.create', ['circles' => $data]);
    }
    ...
    public function edit($id)
    {
        ...
        $circles = Circle::all();
        return response()->view('admin.activities.edit', ['activities' => $activite, 'circles' => $circles]);
    }
