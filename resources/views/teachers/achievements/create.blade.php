                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">إضافة يوم</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{ route('teachers.achievements.store') }}">
                            @csrf
                            <div class="card-body">
                                @if ($errors->any())
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="date" name="date"
                                        placeholder="أدخل تاريخ اليوم" value="{{ old('date') }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="surah" name="surah"
                                        placeholder="أدخل اسم السورة" value="{{ old('surah') }}">
                                </div>
                                <div class="form-group">
                                    <label for="count" class="form-lable">مقدار التسميع</label>
                                    <input type="text" class="form-control" id="count" name="count"
                                        placeholder="من 1-10" value="{{ old('count') }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="note" name="note"
                                        placeholder="ملاحظة عن إنجاز الطالب" value="{{ old('note') }}">
                                </div>
                            </div>
